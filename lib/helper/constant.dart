...
TextStyle textSplash = TextStyle(
  fontFamily: 'Ubuntu',
...
TextStyle textOnBoardingHead = GoogleFonts.poppins(
  color: Colors.black,
  fontSize: 30,
  fontWeight: FontWeight.w500
);

TextStyle textOnBoardingSub = GoogleFonts.poppins(
    color: Colors.grey,
    fontSize: 16,
    fontWeight: FontWeight.w400
);

TextStyle textButtonBoarding = GoogleFonts.poppins(
    color: Colors.white,
    fontSize: 16,
    fontWeight: FontWeight.w500
);
...
TextStyle categoryText = GoogleFonts.roboto(
    color: Colors.black,
    fontSize: 19,
    fontWeight: FontWeight.w600
);
